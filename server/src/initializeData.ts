...
export const initializeDatabase = async () => {
    ...
    tour1.tourID = 1
    tour1.city = "Turku"
    tour1.type = "Walking around the city center"
    ...
    const tour4 = new Tours()
     tour4.tourID = 4
     tour4.city = "New York"
     tour4.type = "Walking around the city center"
    ...
    tour6.type = "Walking around the city center"
    ...
    const tour7 = new Tours()
     tour7.tourID = 7
     tour7.city = "Pisa"
     tour7.type = "Walking around the city center"
