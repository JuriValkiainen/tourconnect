...
export const initializeDatabase = async () => {
  try {
    ...
    russianGuide.description =
      "Профессиональный гид с 10-летним опытом. Провожу увлекательные экскурсии по главным городам России. Специализация: история, архитектура и местные традиции.";
    russianGuide.email = "ivan.petrov@tourconnect.ru";
    russianGuide.phone = "+79161234567";
    russianGuide.photo =
      "https://cdn.pixabay.com/photo/2018/01/17/07/06/laptop-3087585_1280.jpg"; // Фото гида (можно заменить)
    ...
    petersburgTour.description =
      "Discover one of the world's largest art collections in the Winter Palace. The Hermitage houses masterpieces by Rembrandt, Da Vinci, and Michelangelo, along with golden treasures of Scythians. The tour includes the stunning interiors of the tsarist residence.";
    petersburgTour.picture =
      "https://images.pexels.com/photos/20635059/pexels-photo-20635059/free-photo-of-maamerkki-iltahamara-valokuvaus-vaeltaminen.jpeg?auto=compress&cs=tinysrgb&w=600";
    ...
    moscowTour.description =
      "Explore the heart of Russia with a guided tour of Red Square, a UNESCO World Heritage Site. See the iconic St. Basil's Cathedral, Lenin's Mausoleum, and the Kremlin walls. Learn about Russia's tsarist and Soviet history while walking on centuries-old cobblestones.";
    moscowTour.picture =
      "https://images.pexels.com/photos/11042792/pexels-photo-11042792.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
    ...
    kazanTour.description =
      "Kazan is where Europe meets Asia. The Kazan Kremlin, a UNESCO site, combines Russian Orthodox and Tatar Muslim architecture. Visit the Qolşärif Mosque, the Annunciation Cathedral, and the leaning Soyembika Tower. Taste traditional Tatar dishes like echpochmak after the tour.";
    kazanTour.picture =
      "https://images.pexels.com/photos/8723822/pexels-photo-8723822.jpeg?auto=compress&cs=tinysrgb&w=600";
